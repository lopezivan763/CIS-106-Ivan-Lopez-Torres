...
##Assignment 4
On these new assignments, I got to experience more with python and atom as my IDE. I did not want to do too much work with Flowgorithem because I wanted to get hands-on the real stuff. Flowgorithem makes a more clear picture but again I want to get used to the challenge and the errors. there is an error that I remember having and it was space in between logical parts of the code. I struggle so much to understand what that meant. issues like this are what I'm going to face in these courses, I just wish I would have more time to make my life easier with these assignments. Hoping to learn more in this course. 
